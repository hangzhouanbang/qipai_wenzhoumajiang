...
public class WenzhouMajiangJuPlayerResultMO {
	...
	public WenzhouMajiangJuPlayerResultMO(WenzhouMajiangJuPlayerResult juPlayerResult,
	...
	public WenzhouMajiangJuPlayerResultMO(MajiangGamePlayerDbo majiangGamePlayerDbo) {
		playerId = majiangGamePlayerDbo.getPlayerId();
		nickname = majiangGamePlayerDbo.getNickname();
		headimgurl = majiangGamePlayerDbo.getHeadimgurl();
		huCount = 0;
	...
	public WenzhouMajiangJuPlayerResultMO() {
